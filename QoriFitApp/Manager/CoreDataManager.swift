...
class CoreDataManager {
    ...
    func savePreferences(steps: Int32, calories: Int32, session: UUID, distUnit: String, weightUnit: String, username: String) {
        ...
        do {
            ...
            prefs.stepsGoal = Int16(steps)
            prefs.caloriesGoal = Int16(calories)
